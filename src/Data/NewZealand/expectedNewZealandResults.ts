...
export const EXPECTED_NEW_ZEALAND_LINKS: IExpectedLinks = {
    ...
    expectedUrlLand: 'https://www.kingbillycasino.com/land/en-NZ/kings_world_welcome_pack_1'
}

export const EXPECTED_NEW_ZEALAND_LINKS_NDB: IExpectedLinksNDB = {
    expectedUrlNDB: 'https://www.kingbillycasino.com/land/en-NZ/ndb_4',
    expectedUrlNoDep: 'https://www.kingbillycasino.com/land/en-NZ/kings_no_dep_4'
}
...
export const EXPECTED_NEW_ZEALAND_STAGE_WELCOME_LINKS: IExpectedLinks = {
    ...
    expectedUrlLand: 'https://www.kingbillycasino1.com/land/en-NZ/kings_world_welcome_pack_1'
}


 export const EXPECTED_NEW_ZEALAND_STAGE_NDB_LINKS: IExpectedLinksNDB = {
    expectedUrlNDB: 'https://www.kingbillycasino1.com/land/en-NZ/ndb_4',
    expectedUrlNoDep: 'https://www.kingbillycasino1.com/land/en-NZ/kings_no_dep_4'
}
