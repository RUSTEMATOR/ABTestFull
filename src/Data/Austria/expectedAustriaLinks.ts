...
export const EXPECTED_AUSTRIA_STAGE_WELCOME_LINKS: IExpectedLinksWelcome = {
    Welcome: 'https://www.kingbillycasino1.com/land/at/kings_welcome_pack_1',
    Land: 'https://www.kingbillycasino1.com/land/at/kings_land_1'
}


 export const EXPECTED_AUSTRIA_STAGE_NDB_LINKS: IExpectedLinksNDB = {
    expectedUrlNDB: 'https://www.kingbillycasino1.com/land/at/ndb_2',
    expectedUrlNoDep: 'https://www.kingbillycasino1.com/land/at/kings_no_dep_2'
}
