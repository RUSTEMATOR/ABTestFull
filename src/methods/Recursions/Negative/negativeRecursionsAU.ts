...
export default class NegativeRecursionsAU {

    constructor(){}

    async NegativeRecursiveTestWelcomeAUStag(wrongEmail: string, stageLink?: string): Promise<any> {
        ...
        if (baseCurrentUrl === EXPECTED_AUSTRALIA_WELCOME_LINKS.Welcome){
            ...
            methods.sleep(1000)
            await ctx.close();
            return this.NegativeRecursiveTestWelcomeAUStag(wrongEmail);
        }

    }

    async NegativeRecursiveTestWelcomeAUBtag(wrongEmail: string, stageLink?: string): Promise<any> {
        let browser = await startBrowser()
        let ctx = await browser.newContext()
        let page = await ctx.newPage()
        ...
        if (baseCurrentUrl === EXPECTED_AUSTRALIA_WELCOME_LINKS.Welcome){
            ...
            methods.sleep(1000)
            await ctx.close();
            return this.NegativeRecursiveTestWelcomeAUBtag(wrongEmail);
        }

    }


    async NegativeRecursiveTestWorldAUStag(wrongEmail: string, stageLink?: string): Promise<any> {
        let browser = await startBrowser()
        let ctx = await browser.newContext()
        let page = await ctx.newPage()
        ...
        if (baseCurrentUrl === EXPECTED_AUSTRALIA_WELCOME_LINKS.World){
            ...
            await methods.sleep(1000)
            await ctx.close();
            return this.NegativeRecursiveTestWorldAUStag(wrongEmail);
        }

    }

    async NegativeRecursiveTestWorldAUBtag(wrongEmail: string, stageLink?: string): Promise<any> {
        ...
        if (baseCurrentUrl === EXPECTED_AUSTRALIA_WELCOME_LINKS.World){
            ...
            await methods.sleep(1000)
            await ctx.close();
            return this.NegativeRecursiveTestWorldAUBtag(wrongEmail);
        }
    ...
    async NegativeRecursiveTestAUNoDepBtag(wrongEmail: string, stageLink?: string): Promise<any> {
        let browser = await startBrowser()
        let ctx = await browser.newContext()
        let page = await ctx.newPage()
        ...
        if (baseCurrentUrl === EXPECTED_AUSTRALIA_NDB_LINKS.expectedUrlNoDep){
            ...
            await methods.sleep(1000)
            await ctx.close();
            return this.NegativeRecursiveTestAUNoDepBtag(wrongEmail);
        }

    }

    async NegativeRecursiveTestAUNDBBtag(wrongEmail: string, stageLink?: string): Promise<any> {
        let browser = await startBrowser()
        let ctx = await browser.newContext()
        let page = await ctx.newPage()
        ...
        if (baseCurrentUrl === EXPECTED_AUSTRALIA_NDB_LINKS.expectedUrlNDB){
            ...
            await methods.sleep(1000)
            await ctx.close();
            return this.NegativeRecursiveTestAUNDBBtag(wrongEmail);
        }

    }


    async NegativeRecursiveTestAUNoDepStag(wrongEmail: string, stageLink?: string): Promise<any> {
        let browser = await startBrowser()
        let ctx = await browser.newContext()
        let page = await ctx.newPage()
        ...
        if (baseCurrentUrl === EXPECTED_AUSTRALIA_NDB_LINKS.expectedUrlNoDep){
            ...
            await methods.sleep(1000)
            await ctx.close();
            return this.NegativeRecursiveTestAUNoDepStag(wrongEmail);
        }

    }

    async NegativeRecursiveTestAUNDBStag(wrongEmail: string, stageLink?: string): Promise<any> {
        let browser = await startBrowser()
        let ctx = await browser.newContext()
        let page = await ctx.newPage()
