...
export default class RecursionsCA {

    constructor(){}

    async recursiveTestWelcomeStag(stageLink?: string): Promise<any>{
    ...
    async recursiveTestWelcomeBtag(stageLink?: string): Promise<any>{
        let browser = await startBrowser()
        let ctx = await browser.newContext()
        let page = await ctx.newPage()
    ...
    async recursiveTestLandStag(stageLink?: string): Promise<any> {
    ...
    async recursiveTestLandBtag(stageLink?: string): Promise<any> {
    ...
    async recursiveTestCANoDepBtag(stageLink?: string): Promise<any> {
        let browser = await startBrowser()
        let ctx = await browser.newContext()
        let page = await ctx.newPage()
        ...
        if (baseCurrentUrl === EXPECTED_CANADA_LINKS_NDB.expectedUrlNoDep){
            ...
            await methods.sleep(1000)
            await ctx.close();
            return this.recursiveTestCANoDepBtag();
        }

    }

    async recursiveTestCANDBBtag(stageLink?: string): Promise<any> {
        let browser = await startBrowser()
        let ctx = await browser.newContext()
        let page = await ctx.newPage()
        ...
        if (baseCurrentUrl === EXPECTED_CANADA_LINKS_NDB.expectedUrlNDB){
            ...
            await methods.sleep(1000)
            await ctx.close();
            return this.recursiveTestCANDBBtag();
        }

    }


    async recursiveTestCANoDepStag(stageLink?: string): Promise<any> {
        let browser = await startBrowser()
        let ctx = await browser.newContext()
        let page = await ctx.newPage()
        ...
        if (baseCurrentUrl === EXPECTED_CANADA_LINKS_NDB.expectedUrlNoDep){
            ...
            await methods.sleep(1000)
            await ctx.close();
            return this.recursiveTestCANoDepStag();
        }

    }

    async recursiveTestCANDBStag(stageLink?: string): Promise<any> {
        let browser = await startBrowser()
        let ctx = await browser.newContext()
        let page = await ctx.newPage()
        ...
        if (baseCurrentUrl === EXPECTED_CANADA_LINKS_NDB.expectedUrlNDB){
            ...
            await methods.sleep(1000)
            await ctx.close();
            return this.recursiveTestCANDBStag();
        }
