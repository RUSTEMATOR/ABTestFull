...
import { RegMethods3Step } from "../../src/methods/regMethods3step";
import RandomEmail from "../../src/randomEmail/randomEmail";
import { PHONE_NUMBERS } from "../../src/Data/constants";
...
test.describe('Registration part of the AB test', () => {
    ...
    const btagLink = redirectLinks.AuBtag
    ...
    test(`${country} Registration Test`, async () => {
        await registration.recursiveRegistration({url: btagLink,
